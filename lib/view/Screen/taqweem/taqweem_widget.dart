...
class TaqweemWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<TaqweemWidget> createState() => _TaqweemWidgetState();
}

class _TaqweemWidgetState extends State<TaqweemWidget> {
  final Stream<QuerySnapshot> datapdfStrem =
  FirebaseFirestore.instance.collection("taqweempdf").snapshots();
