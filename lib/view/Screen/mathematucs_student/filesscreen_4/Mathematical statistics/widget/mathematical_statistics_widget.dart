...
class MathematicalStatisticsWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<MathematicalStatisticsWidget> createState() => _MathematicalStatisticsWidgetState();
}

class _MathematicalStatisticsWidgetState extends State<MathematicalStatisticsWidget> {
