...
class ComplexAnalysisWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<ComplexAnalysisWidget> createState() => _ComplexAnalysisWidgetState();
}

class _ComplexAnalysisWidgetState extends State<ComplexAnalysisWidget> {
