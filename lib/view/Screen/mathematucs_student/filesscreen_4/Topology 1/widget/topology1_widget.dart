...
class Topology1Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<Topology1Widget> createState() => _Topology1WidgetState();
}

class _Topology1WidgetState extends State<Topology1Widget> {
