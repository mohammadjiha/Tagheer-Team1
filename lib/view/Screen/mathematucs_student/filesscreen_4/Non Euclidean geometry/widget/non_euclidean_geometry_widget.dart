...
class NonEuclideanGeometryWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<NonEuclideanGeometryWidget> createState() => _NonEuclideanGeometryWidgetState();
}

class _NonEuclideanGeometryWidgetState extends State<NonEuclideanGeometryWidget> {
