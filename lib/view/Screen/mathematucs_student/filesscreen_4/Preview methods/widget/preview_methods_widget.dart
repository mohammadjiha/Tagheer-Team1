...
class PreviewMethodsWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<PreviewMethodsWidget> createState() => _PreviewMethodsWidgetState();
}

class _PreviewMethodsWidgetState extends State<PreviewMethodsWidget> {
