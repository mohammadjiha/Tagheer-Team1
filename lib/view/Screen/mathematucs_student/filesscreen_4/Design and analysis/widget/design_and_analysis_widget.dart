...
class DesignAndAnalysisWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<DesignAndAnalysisWidget> createState() => _DesignAndAnalysisWidgetState();
}

class _DesignAndAnalysisWidgetState extends State<DesignAndAnalysisWidget> {
