...
class AbstractAlgebra1Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<AbstractAlgebra1Widget> createState() => _AbstractAlgebra1WidgetState();
}

class _AbstractAlgebra1WidgetState extends State<AbstractAlgebra1Widget> {
