...
class StatementTheoryWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<StatementTheoryWidget> createState() => _StatementTheoryWidgetState();
}

class _StatementTheoryWidgetState extends State<StatementTheoryWidget> {
