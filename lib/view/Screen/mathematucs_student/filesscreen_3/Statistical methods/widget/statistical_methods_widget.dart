...
class StatisticalMethodsWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<StatisticalMethodsWidget> createState() => _StatisticalMethodsWidgetState();
}

class _StatisticalMethodsWidgetState extends State<StatisticalMethodsWidget> {
