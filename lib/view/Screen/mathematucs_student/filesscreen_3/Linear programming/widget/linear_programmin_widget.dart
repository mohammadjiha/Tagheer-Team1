...
class LinearProgrammingWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<LinearProgrammingWidget> createState() => _LinearProgrammingWidgetState();
}

class _LinearProgrammingWidgetState extends State<LinearProgrammingWidget> {
