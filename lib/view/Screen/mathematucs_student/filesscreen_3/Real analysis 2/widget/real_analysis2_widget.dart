...
class RealAnalysis2Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<RealAnalysis2Widget> createState() => _RealAnalysis2WidgetState();
}

class _RealAnalysis2WidgetState extends State<RealAnalysis2Widget> {
