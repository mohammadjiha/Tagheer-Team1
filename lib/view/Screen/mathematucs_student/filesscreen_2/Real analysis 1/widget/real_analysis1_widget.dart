...
class RealAnalysis1Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<RealAnalysis1Widget> createState() => _RealAnalysis1WidgetState();
}

class _RealAnalysis1WidgetState extends State<RealAnalysis1Widget> {
