...
class UsusRiadiaatWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<UsusRiadiaatWidget> createState() => _UsusRiadiaatWidgetState();
}

class _UsusRiadiaatWidgetState extends State<UsusRiadiaatWidget> {
