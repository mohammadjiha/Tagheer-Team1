...
class HazmBarmajiatRiadiaWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<HazmBarmajiatRiadiaWidget> createState() => _HazmBarmajiatRiadiaWidgetState();
}

class _HazmBarmajiatRiadiaWidgetState extends State<HazmBarmajiatRiadiaWidget> {
