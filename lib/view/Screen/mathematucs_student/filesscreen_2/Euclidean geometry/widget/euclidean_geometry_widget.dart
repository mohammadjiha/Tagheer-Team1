...
class EuclideanGeometryWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<EuclideanGeometryWidget> createState() => _EuclideanGeometryWidgetState();
}

class _EuclideanGeometryWidgetState extends State<EuclideanGeometryWidget> {
