...
class LapPhsiscs3Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<LapPhsiscs3Widget> createState() => _LapPhsiscs3WidgetState();
}

class _LapPhsiscs3WidgetState extends State<LapPhsiscs3Widget> {
