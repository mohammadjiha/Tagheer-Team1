...
class ComputationWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<ComputationWidget> createState() => _ComputationWidgetState();
}

class _ComputationWidgetState extends State<ComputationWidget> {
