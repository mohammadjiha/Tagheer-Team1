...
class CategoryFilesPhysisc extends StatelessWidget {
  static const String RoutName = 'CategoryFilesPhysisc';

  const CategoryFilesPhysisc({super.key});
          ...
          Expanded(
            ...
            child: Column(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                   Get.toNamed(ItemSecondPhysisc.RoutName);
                  },
                  child: const ChiocStudent(
                      images: 'assets/image/icons8-student-64 1.png',
                ...
                GestureDetector(
                  onTap: () {
                   Get.toNamed(ItemTherdPhysisc.RoutName);
                  },
                  child: const ChiocStudent(
                      images: 'assets/image/icons8-student-64 1.png',
                ...
                GestureDetector(
                  onTap: () {
                    Get.toNamed(ItemFoarthPhysisc.RoutName);
                  },
                  child: const ChiocStudent(
                      images: 'assets/image/icons8-student-64 1.png',
