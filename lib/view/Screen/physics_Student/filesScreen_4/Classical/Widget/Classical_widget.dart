...
class ClassicalWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<ClassicalWidget> createState() => _ClassicalWidgetState();
}

class _ClassicalWidgetState extends State<ClassicalWidget> {
