...
class LabapplicationsWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<LabapplicationsWidget> createState() => _LabapplicationsWidgetState();
}

class _LabapplicationsWidgetState extends State<LabapplicationsWidget> {
