...
class SemiCondWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<SemiCondWidget> createState() => _SemiCondWidgetState();
}

class _SemiCondWidgetState extends State<SemiCondWidget> {
