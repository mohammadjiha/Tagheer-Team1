...
class LaserWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<LaserWidget> createState() => _LaserWidgetState();
}

class _LaserWidgetState extends State<LaserWidget> {
  final Stream<QuerySnapshot> datapdfStrem =
      FirebaseFirestore.instance.collection("Laser").snapshots();
