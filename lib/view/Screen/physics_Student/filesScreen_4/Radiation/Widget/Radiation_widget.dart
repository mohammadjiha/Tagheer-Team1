...
class RadiationWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<RadiationWidget> createState() => _RadiationWidgetState();
}

class _RadiationWidgetState extends State<RadiationWidget> {
