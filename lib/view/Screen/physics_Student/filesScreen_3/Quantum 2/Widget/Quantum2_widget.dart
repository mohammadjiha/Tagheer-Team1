...
class Quantum2Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<Quantum2Widget> createState() => _Quantum2WidgetState();
}

class _Quantum2WidgetState extends State<Quantum2Widget> {
