...
class Quantum1Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<Quantum1Widget> createState() => _Quantum1WidgetState();
}

class _Quantum1WidgetState extends State<Quantum1Widget> {
