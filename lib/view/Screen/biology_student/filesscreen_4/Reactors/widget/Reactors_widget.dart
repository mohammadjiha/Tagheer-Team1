...
class ReactorsWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<ReactorsWidget> createState() => _ReactorsWidgetState();
}

class _ReactorsWidgetState extends State<ReactorsWidget> {
