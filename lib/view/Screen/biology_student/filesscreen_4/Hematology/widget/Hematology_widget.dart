...
class HematologyWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<HematologyWidget> createState() => _HematologyWidgetState();
}

class _HematologyWidgetState extends State<HematologyWidget> {
