...
class GeneralMicrobiologyWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<GeneralMicrobiologyWidget> createState() => _GeneralMicrobiologyWidgetState();
}

class _GeneralMicrobiologyWidgetState extends State<GeneralMicrobiologyWidget> {
