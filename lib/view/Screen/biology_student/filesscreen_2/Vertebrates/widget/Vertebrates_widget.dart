...
class VertebratesWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<VertebratesWidget> createState() => _VertebratesWidgetState();
}

class _VertebratesWidgetState extends State<VertebratesWidget> {
