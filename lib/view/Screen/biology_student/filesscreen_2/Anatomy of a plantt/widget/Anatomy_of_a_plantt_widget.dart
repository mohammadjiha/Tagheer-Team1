...
class AnatomyOfAplanttWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<AnatomyOfAplanttWidget> createState() => _AnatomyOfAplanttWidgetState();
}

class _AnatomyOfAplanttWidgetState extends State<AnatomyOfAplanttWidget> {
