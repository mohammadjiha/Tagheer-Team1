...
class PracticalLifeSciences2Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<PracticalLifeSciences2Widget> createState() => _PracticalLifeSciences2WidgetState();
}

class _PracticalLifeSciences2WidgetState extends State<PracticalLifeSciences2Widget> {
