...
class CellBiologyWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<CellBiologyWidget> createState() => _CellBiologyWidgetState();
}

class _CellBiologyWidgetState extends State<CellBiologyWidget> {
