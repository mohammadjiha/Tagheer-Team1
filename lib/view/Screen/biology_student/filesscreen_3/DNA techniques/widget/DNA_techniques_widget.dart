...
class DnaTechniquesWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<DnaTechniquesWidget> createState() => _DnaTechniquesWidgetState();
}

class _DnaTechniquesWidgetState extends State<DnaTechniquesWidget> {
