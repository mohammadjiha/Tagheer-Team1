...
class AnimalPhysiologyWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<AnimalPhysiologyWidget> createState() => _AnimalPhysiologyWidgetState();
}

class _AnimalPhysiologyWidgetState extends State<AnimalPhysiologyWidget> {
