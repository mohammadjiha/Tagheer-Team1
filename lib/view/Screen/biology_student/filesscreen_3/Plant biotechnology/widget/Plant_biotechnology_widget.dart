...
class PlantBiotechnologyWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<PlantBiotechnologyWidget> createState() => _PlantBiotechnologyWidgetState();
}

class _PlantBiotechnologyWidgetState extends State<PlantBiotechnologyWidget> {
