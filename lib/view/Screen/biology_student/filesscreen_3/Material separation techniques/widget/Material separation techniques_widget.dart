...
class MaterialSeparationTechniquesWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<MaterialSeparationTechniquesWidget> createState() => _MaterialSeparationTechniquesWidgetState();
}

class _MaterialSeparationTechniquesWidgetState extends State<MaterialSeparationTechniquesWidget> {
