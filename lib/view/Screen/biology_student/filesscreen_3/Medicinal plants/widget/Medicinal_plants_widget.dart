...
class MedicinalPlantsWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<MedicinalPlantsWidget> createState() => _MedicinalPlantsWidgetState();
}

class _MedicinalPlantsWidgetState extends State<MedicinalPlantsWidget> {
