...
class Physics1Widget extends StatefulWidget {
  ...
  @override
  State<Physics1Widget> createState() => _CWidgetState();
}

class _CWidgetState extends State<Physics1Widget> {
  final Stream<QuerySnapshot> datapdfStrem =
      FirebaseFirestore.instance.collection('Physics 1').snapshots();
