...
class lapchem105Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<lapchem105Widget> createState() => _lapchem105WidgetState();
}

class _lapchem105WidgetState extends State<lapchem105Widget> {
  final Stream<QuerySnapshot> datapdfStrem =
      FirebaseFirestore.instance.collection('lab chem105').snapshots();
