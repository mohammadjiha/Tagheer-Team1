...
class ChemWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
      pathName; // افتراضي أن pathName هو اسم الحقل الذي تريد الوصول إليه
  final String NameCollectin;
  ...
  const ChemWidget({
    ...
    required this.NameCollectin,
  });

  @override
  State<ChemWidget> createState() => _ChemWidgetState();
}

class _ChemWidgetState extends State<ChemWidget> {
