...
class Chem2Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<Chem2Widget> createState() => _Chem2WidgetState();
}

class _Chem2WidgetState extends State<Chem2Widget> {
  final Stream<QuerySnapshot> datapdfStrem =
      FirebaseFirestore.instance.collection('chem102').snapshots();
