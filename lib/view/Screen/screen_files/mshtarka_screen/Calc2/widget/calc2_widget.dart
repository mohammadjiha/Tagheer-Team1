...
class Calc2Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<Calc2Widget> createState() => _Calc2WidgetState();
}

class _Calc2WidgetState extends State<Calc2Widget> {
  final Stream<QuerySnapshot> datapdfStrem =
      FirebaseFirestore.instance.collection('كالك2').snapshots();
