...
class SpecialAnalyticalWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<SpecialAnalyticalWidget> createState() =>
      _SpecialAnalyticalWidgetState();
}

class _SpecialAnalyticalWidgetState extends State<SpecialAnalyticalWidget> {
