...
import '../widget/sbishil_eudwia_widget.dart';

class SbishilEudwia extends StatefulWidget {
  static const String RoutName = 'SbishilEudwia';

  const SbishilEudwia({super.key});

  @override
  State<SbishilEudwia> createState() => _SbishilEudwiaState();
}

class _SbishilEudwiaState extends State<SbishilEudwia> {
  final Stream<QuerySnapshot> datapdfStrem =
      FirebaseFirestore.instance.collection("sbishil eudwia").snapshots();
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SbishilEudwiaWidget(
                              text1: "سبيشال عضوية",
                              text3: "HETEROCYCLIC CHEMISTRY",
                              text2: "كتاب المادة",
                          ...
                          const SbishilEudwiaWidget(
                              text1: "سبيشال عضوية",
                              text3: "",
                              text2: "Green chemistry",
                              pathName: "Green chemistry"),
                          SizedBox(
                            width: 5.w,
                          ),
                        ],
