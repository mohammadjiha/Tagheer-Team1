...
class InOrgani3Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<InOrgani3Widget> createState() => _InOrgani3WidgetState();
}

class _InOrgani3WidgetState extends State<InOrgani3Widget> {
  final Stream<QuerySnapshot> datapdfStrem =
      FirebaseFirestore.instance.collection(" inorganic 3 ").snapshots();
