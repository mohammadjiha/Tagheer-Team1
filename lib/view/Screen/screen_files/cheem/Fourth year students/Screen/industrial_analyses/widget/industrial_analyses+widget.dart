...
class IndustrialAnalysesWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<IndustrialAnalysesWidget> createState() =>
      _IndustrialAnalysesWidgetState();
}

class _IndustrialAnalysesWidgetState extends State<IndustrialAnalysesWidget> {
