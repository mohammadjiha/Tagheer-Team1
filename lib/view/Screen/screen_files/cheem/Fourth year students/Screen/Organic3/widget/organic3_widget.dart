...
class organic3Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<organic3Widget> createState() => _organic3WidgetState();
}

class _organic3WidgetState extends State<organic3Widget> {
