...
class EnviromentalAnalysisWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<EnviromentalAnalysisWidget> createState() =>
      _EnviromentalAnalysisWidgetState();
}

class _EnviromentalAnalysisWidgetState
    extends State<EnviromentalAnalysisWidget> {
