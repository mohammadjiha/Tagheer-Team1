...
import '../Widget/hetero_widget.dart';

class Hetero extends StatefulWidget {
  static const String RoutName = 'Hetero';

  const Hetero({super.key});

  @override
  State<Hetero> createState() => _HeteroState();
}

class _HeteroState extends State<Hetero> {
  final Stream<QuerySnapshot> datapdfStrem =
      FirebaseFirestore.instance.collection("هيتيرو ").snapshots();
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const HeteroWidget(
                              text1: "هتيرو",
                              text3: "للدكتور سليمان",
                              text2: "سلايدات شرح هتيرو",
                              pathName: "سلايدات"),
                          SizedBox(
                            width: 5.w,
                          ),
