...
class OrganometallicWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<OrganometallicWidget> createState() => _OrganometallicWidgetState();
}

class _OrganometallicWidgetState extends State<OrganometallicWidget> {
