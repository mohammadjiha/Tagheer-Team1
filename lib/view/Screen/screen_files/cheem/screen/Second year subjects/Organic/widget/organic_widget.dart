...
class organic1Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<organic1Widget> createState() => _organic1WidgetState();
}

class _organic1WidgetState extends State<organic1Widget> {
