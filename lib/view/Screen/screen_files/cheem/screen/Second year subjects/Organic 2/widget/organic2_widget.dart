...
class organic2Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<organic2Widget> createState() => _organic2WidgetState();
}

class _organic2WidgetState extends State<organic2Widget> {
