...
class LapAnalyticalWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<LapAnalyticalWidget> createState() => _LapAnalyticalWidgetState();
}

class _LapAnalyticalWidgetState extends State<LapAnalyticalWidget> {
