...
class LapInOrganicWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<LapInOrganicWidget> createState() => _LapInOrganicWidgetState();
}

class _LapInOrganicWidgetState extends State<LapInOrganicWidget> {
