...
class InOrganic2Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<InOrganic2Widget> createState() => _InOrganic2WidgetState();
}

class _InOrganic2WidgetState extends State<InOrganic2Widget> {
