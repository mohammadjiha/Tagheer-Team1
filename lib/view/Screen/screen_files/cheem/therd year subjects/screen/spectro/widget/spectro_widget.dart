...
class SpectroWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<SpectroWidget> createState() => _SpectroWidgetState();
}

class _SpectroWidgetState extends State<SpectroWidget> {
  final Stream<QuerySnapshot> datapdfStrem =
      FirebaseFirestore.instance.collection("Spectro").snapshots();
