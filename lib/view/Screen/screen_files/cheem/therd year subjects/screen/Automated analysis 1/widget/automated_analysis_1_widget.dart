...
class AutomatedAnalysis1Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<AutomatedAnalysis1Widget> createState() =>
      _AutomatedAnalysis1WidgetState();
}

class _AutomatedAnalysis1WidgetState extends State<AutomatedAnalysis1Widget> {
