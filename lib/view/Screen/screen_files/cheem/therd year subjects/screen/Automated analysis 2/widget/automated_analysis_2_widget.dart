...
class AutomatedAnalysis2Widget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<AutomatedAnalysis2Widget> createState() =>
      _AutomatedAnalysis2WidgetState();
}

class _AutomatedAnalysis2WidgetState extends State<AutomatedAnalysis2Widget> {
