...
class LapAutomatedAnalysisWidget extends StatefulWidget {
  final String text1;
  final String text2;
  final String text3;
  final String
  ...
  @override
  State<LapAutomatedAnalysisWidget> createState() =>
      _LapAutomatedAnalysisWidgetState();
}

class _LapAutomatedAnalysisWidgetState
    extends State<LapAutomatedAnalysisWidget> {
